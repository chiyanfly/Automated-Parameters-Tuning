...
if __name__ == "__main__":
    for file in os.listdir(testfilePath):
        ...
        cen_resultfile = open(cen_resultpath + file + "_VaraibleGraph_cen.csv", "w")
        cen_resultfile.write("Variable/Cons" + "," + "Betweenness centrality" + "\n")
        degree_resultfile = open(degree_result_path + file + "_VaraibleGraph_degree.csv", "w")
        degree_resultfile.write("Variable/Cons" + "," + "Degree" + "\n")


        My_Graph, dic_id_objet = G.creatVN_Graph(csppath)
